...
<title>⚔️ Alzaeem Tech ⚔️</title>
<link rel="icon" type="image/png" href="https://cdn-icons-png.flaticon.com/512/4712/4712108.png">
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css">
<style>
  body { margin:0; font-family:"Segoe UI",sans-serif; background:linear-gradient(135deg,#0d0d0d,#1a1a1a,#262626); color:white; overflow-x:hidden; }
...
<body>
  ...
  <header>⚔️ 𝒜𝓁𝓏𝒶𝒾𝓂 𝒯𝑒𝒸𝒽 ⚔️ <i class="fa-solid fa-brain" style="color:#0ff;"></i></header>
  <div class="sidebar" id="sidebar">
    <div>
      ...
      <div class="links">
        <a href="https://alzaeem1.gt.tc/index"><i class="fa-solid fa-house"></i> Home</a>
        <a href="https://alzaeem1.gt.tc/rule%20unive"><i class="fa-solid fa-circle-info"></i> University of Computers and Information</a>
        <a href="https://alzaeem1.gt.tc/rule%20stud"><i class="fa-solid fa-gear"></i> Student values</a>
        <a href="https://alzaeem1.gt.tc/rule%20doct"><i class="fa-solid fa-briefcase"></i> Teacher values</a>
        <a href="https://alzaeem1.gt.tc/student"><i class="fa-solid fa-brain"></i> Student page</a>
        <a href="https://alzaeem1.gt.tc/Main"><i class="fa-solid fa-code"></i> Registration page</a>
        <a href="https://alzaeem1.gt.tc/file"><i class="fa-solid fa-shield-halved"></i> Student files</a>
        <a href="https://alzaeem1.gt.tc/search1_hub"><i class="fa-solid fa-users"></i> Google and Microsoft services</a>
        <a href="https://alzaeem1.gt.tc/search_hub"><i class="fa-solid fa-headset"></i> Software definitions</a>
        <a href="https://mail.google.com/mail/?view=cm&fs=1&to=mohamedyhyamostafa@gmail.com"><i class="fa-solid fa-envelope"></i> Email for correspondence and inquiries</a>
      </div>
    </div>
    <div class="footer">
  ...
  <div class="content">
    <div class="welcome">✨ Power • Intelligence • Future ✨</div>
    <div class="message">⚔️ Where AI Meets Warriors of Technology ⚔️</div>
    <div class="logo">
      ...
      <p style="margin-top:10px;">The Untamed Stallion of Sharqia 🐎</p>
    </div>
  </div>
  <div class="cloud" style="top:25%;animation-delay:0s;">🤖 Artificial Intelligence</div>
  <div class="cloud" style="top:35%;animation-delay:5s;">⚡ Neural Networks</div>
  <div class="cloud" style="top:45%;animation-delay:10s;">📊 Data Science</div>
  <div class="cloud" style="top:55%;animation-delay:15s;">🗡️ Cyber Defense</div>
  <div class="cloud" style="top:65%;animation-delay:20s;">🚀 Robotics & Automation</div>
  <div class="cloud" style="top:75%;animation-delay:25s;">🌐 Future Networks</div>
  ...
  <button class="voice-btn" onclick="playWelcome()">🔊 Play Welcome Voice</button>
...
function searchPage(){
  ...
  for(let link of links){ if(link.innerText.toLowerCase().includes(input)){ window.location.href=link.href; return; } }
  alert("Page not found!");
}

// تشغيل الصوت التلقائي مع موسيقى قصيرة
...
window.onload = function(){ playWelcome(); }
</script>
</body>
</html>`);
}
